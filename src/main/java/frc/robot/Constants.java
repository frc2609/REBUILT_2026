...
public final class Constants {
    ...
    public static final VelocityMotorType SHOOTER_VELOCITY_MOTOR_TYPE = VelocityMotorType.CTRE_TALON_FX;
    public static final VelocityMotorType INTAKE_ROLLER_VELOCITY_MOTOR_TYPE = VelocityMotorType.CTRE_TALON_FX;
    public static final PositionMotorType INTAKE_DEPLOY_POSITION_MOTOR_TYPE = PositionMotorType.CTRE_TALON_FX;
    ...
    public static final class Intake {
        public static final Map<String, Object> cfg = new HashMap<>(Map.of(
