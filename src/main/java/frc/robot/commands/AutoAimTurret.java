...
public class AutoAimTurret extends Command {
    ...
    private boolean higherRPMTolerance = false;
    ...
    public void execute() {
        ...
        Logger.recordOutput("SOTM/Flags/FlywheelTolerance", higherRPMTolerance);
    }
    ...
    public boolean higherFlywheelTolerance() {
        return higherRPMTolerance;
    }
