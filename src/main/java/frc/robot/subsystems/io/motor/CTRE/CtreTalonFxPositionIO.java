...
public class CtreTalonFxPositionIO implements PositionMotorIO {
  ...
  public CtreTalonFxPositionIO(
      Constants.CtreTalonFxPositionConfig cfg, int motorId, double gearRatio, double encoderRatio) {
  ...
  public boolean isAtPosition(double toleranceDegrees) {
    // Compare measured position to the last commanded setpoint in degrees (matches SparkMax + sim
    // behavior).
